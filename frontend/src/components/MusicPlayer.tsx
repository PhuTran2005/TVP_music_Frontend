...
//   toggleRepeat,
//   stopListening,
//   setDuration, // Import action setDuration
...
//   // --- 1. SETUP SOCKET & ANALYTICS ---
//   const { socket, isConnected } = useSocket();

//   // Hook này chỉ lo việc gửi Heartbeat (User Online) mỗi 10s
//   useTrackAnalytics();

//   // Refs để xử lý logic đếm view 90% (Local logic, không gây lag Redux)
...
//   // --- 3. OPTIMISTIC SEEK STATE ---
//   const [isDraggingSlider, setIsDraggingSlider] = useState(false);
//   const [sliderValue, setSliderValue] = useState(0);

//   // --- 4. LOGIC RESET ANALYTICS ---
//   useEffect(() => {
//     if (currentTrack?._id !== lastTrackIdRef.current) {
//       hasRecordedViewRef.current = false; // Reset cờ đếm view
//       lastTrackIdRef.current = currentTrack?._id || null;
//     }
//   }, [currentTrack?._id]);

//   // --- 5. DRAG LOGIC (Mobile Dismiss) ---
...
//   // 🔥 Xử lý logic Prev Track 3s Rule tại UI (Do Redux không biết currentTime)
//   const handlePrevTrack = () => {
//     if (currentTime > 3) {
//       seek(0); // Replay từ đầu
//     } else {
//       dispatch(prevTrack()); // Back về bài trước
//     }
//   };

//   return (
//     <>
//       {/* 🔥 AUDIO ELEMENT - TRÁI TIM CỦA PLAYER
//         Xử lý sự kiện onTimeUpdate kép: vừa update UI, vừa tính Analytics
//       */}
//       <audio
//         ref={audioRef}
//         {...events}
//         preload="auto"
//         // Override onLoadedMetadata để cập nhật duration vào Redux cho đẹp
//         onLoadedMetadata={(e) => {
//           dispatch(setDuration(e.currentTarget.duration));
//         }}
//         // Override onTimeUpdate để chèn logic Analytics
//         onTimeUpdate={(e) => {
//           // 1. Chạy logic gốc
...
//             // 👇 LOG DEBUG 1: Kiểm tra xem hàm này có chạy không?
//             // Mở Console trình duyệt, nó phải nhảy số liên tục
//             // console.log("Tiến độ:", progress.toFixed(2), "| HasRecorded:", hasRecordedViewRef.current);

//             // Điều kiện 90%
//             if (!hasRecordedViewRef.current && progress >= 0.9) {
//               console.log("🎯 ĐÃ VÀO LOGIC 90%!"); // 👇 LOG DEBUG 2: Phải thấy dòng này
//               console.log("🔌 Socket Status:", socket?.connected, socket?.id); // 👇 LOG DEBUG 3: Phải là TRUE

//               if (socket && isConnected) {
//                 console.log("🚀 Đang bắn track_play lên server...");
//                 socket.emit("track_play", {
//                   trackId: currentTrack._id,
//                   userId: user?._id,
//                 });
//               } else {
//                 console.error("❌ Socket chưa kết nối, không gửi được!");
//               }
...
//                       {/* 🔥 NÚT PREV - Dùng handlePrevTrack thay vì dispatch trực tiếp */}
//                       <Button
//                         variant="ghost"
//                         size="icon"
...
//                   onClick={(e) => {
//                     e.stopPropagation();
//                     handlePrevTrack(); // Dùng hàm local thay vì dispatch
//                   }}
//                 >
