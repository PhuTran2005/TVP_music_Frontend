...
import { Play, Heart, MoreHorizontal, Users, Verified, Clock, Calendar } from "lucide-react";
...
const artistData = {
  ...
  coverImage: "https://images.unsplash.com/photo-1709731191876-899e32264420?w=1200",
  verified: true,
  ...
  topSongs: [
    {
      ...
      image: "https://images.unsplash.com/photo-1629923759854-156b88c433aa?w=100"
    },
    {
      id: 2,
      title: "Neon Nights",
  ...
  albums: [
    {
      ...
      year: "2024",
      image: "https://images.unsplash.com/photo-1629923759854-156b88c433aa?w=300",
      type: "Album"
    },
    {
      id: 2,
        ...
        <div className="container relative z-20 h-full flex items-end px-4 lg:px-6 pb-8">
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              >
                {artistData.verified && <Verified className="h-6 w-6 text-blue-400" />}
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      >
                        <Heart
                          className={`h-4 w-4 ${
                            likedSongs.has(song.id) ? 'fill-red-500 text-red-500' : 'text-muted-foreground hover:text-foreground'
                          }`}
                        />
                      </motion.button>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="font-medium">{artistData.monthlyListeners}</span>
                    </div>
                    <div className="flex items-center justify-between text-sm">
                      <span className="text-muted-foreground">Followers</span>
                      <span className="font-medium">{artistData.followers}</span>
                    </div>
                    <div className="flex items-center justify-between text-sm">
